...
import itacademy.utils.ReflectionUtil;
...
public abstract class DAOImpl<T> implements DAO<T> {
     ...
     */
    public DAOImpl(Class<T> clazz, Logger logger) {
        this.clazz = clazz;
        this.entityManager = HibernateUtil.getEntityManager();
        this.logger = logger;
        this.tableName = ReflectionUtil.getTableNameByClass(clazz);
    }
    ...
    public T get(Serializable id) {
        ...
        return ExecutorUtil.executeHibernate(this.entityManager, em -> em.find(clazz, id));
    }
